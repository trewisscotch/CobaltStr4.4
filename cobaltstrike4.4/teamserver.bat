...
:run_cobal
	java -XX:ParallelGCThreads=4 -Duser.language=en -Dcobaltstrike.server_port=50050 -Djavax.net.ssl.keyStore=./cobaltstrike.store -Djavax.net.ssl.keyStorePassword=123456 -server -XX:+AggressiveHeap -XX:+UseParallelGC -Xmx1024m -javaagent:hook.jar -classpath ./cobaltstrike.jar server.TeamServer %*